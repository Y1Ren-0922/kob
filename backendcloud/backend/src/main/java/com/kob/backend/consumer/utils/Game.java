...
public class Game extends Thread{
    ...
    private String getInput(Player player) {   // 将当前的局部信息编码成字符串
        Player me, you;
    ...
    private void updateUserRating(Player player, Integer rating) {
        User user = WebSocketServer.userDao.selectById(player.getId());
        user.setRating(rating);
        WebSocketServer.userDao.updateById(user);
    }

    private void saveToDataBase() {
        Integer ratingA = WebSocketServer.userDao.selectById(playerA.getId()).getRating();
        Integer ratingB = WebSocketServer.userDao.selectById(playerB.getId()).getRating();
